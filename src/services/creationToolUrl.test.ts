...
describe("creation tool URL helpers", () => {
  ...
  it("updates the tool while preserving other query parameters and the hash", () => {
    expect(
      setCreationToolInUrl("https://example.com/app?foo=1#result", "inpaint"),
