...
export type CreationTool = 'workflow' | 'scene' | 'scene-replace' | 'scene-replace-tabs' | 'cup-resize' | 'logo' | 'logo-replace' | 'logo-replace-tabs' | 'logo-export' | 'paper-text' | 'background-removal' | 'outpaint' | 'object-replace' | 'inpaint' | 'product-detail';
