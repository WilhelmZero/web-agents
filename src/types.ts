...
export type CreationTool = 'scene' | 'scene-replace' | 'logo' | 'logo-replace' | 'logo-export' | 'paper-text' | 'background-removal' | 'outpaint' | 'object-replace' | 'inpaint' | 'product-detail';
